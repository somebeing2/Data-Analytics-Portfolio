...
# Sidebar Disclaimer
st.sidebar.markdown("---")
st.sidebar.caption("⚠️ **Disclaimer:** This tool is for educational purposes only and does not constitute financial advice.")
...
# Comprehensive Legal Disclaimer in an Expander
with st.expander("⚖️ Legal Disclaimer & Risk Disclosure"):
    st.markdown("""
    **1. General Information Only:** This application ("FreedomCalc") is provided for general informational and educational purposes only. It does not constitute professional financial advice, investment recommendations, or tax planning.
    
    **2. Limitation of Simulations:** The projections generated by this tool are based on mathematical models (Monte Carlo simulations) and user-inputs. These are hypothetical in nature and do not reflect actual trading or investment results. They cannot predict future market conditions, crashes, or economic shifts.
    
    **3. No Guarantee:** There is no guarantee that the financial goals calculated here will be achieved. Investment markets are volatile and subject to fluctuation.
    
    **4. User Responsibility:** You are solely responsible for your own financial decisions. It is strongly recommended that you consult with a qualified financial advisor or certified financial planner (CFP) before making any investment decisions.
    
    **5. Liability:** The creator of this tool shall not be held liable for any errors, omissions, or damages arising from the use of or reliance on the information provided herein.
    """)
