...
# --- 1. CONFIGURATION ---
st.set_page_config(page_title="DiviTrack Fixed", layout="wide", page_icon="✅")

# Force Clear Cache on every load to prevent "Ghost Bugs"
st.cache_data.clear()
...
# --- 4. SIDEBAR ---
st.sidebar.header("✅ FIXED VERSION")
...
# --- 5. MAIN DASHBOARD ---
st.title("✅ DiviTrack: Tax Auditor")
    ...
    for p in st.session_state.portfolio:
        ...
        for d, amt in my_divs.items():
            ...
            all_rows.append({
                ...
                "FY": fy,
                "CY": cy,
                "Q_Display": get_fiscal_quarter(d_obj) if is_fiscal else f"Q{(d_obj.month-1)//3+1}",
                "Year_Display": fy if is_fiscal else cy
            })
